 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const du="FirebaseError";class Ae extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=du,Object.setPrototypeOf(this,Ae.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ho.prototype.create)}}class Ho{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},s=`${this.service}/${t}`,i=this.errors[t],o=i?fu(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ae(s,a,r)}}function fu(e,t){return e.replace(mu,(n,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const mu=/\{\$([^}]+)}/g;function rs(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const s of n){if(!r.includes(s))return!1;const i=e[s],o=t[s];if(Mi(i)&&Mi(o)){if(!rs(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function Mi(e){return e!==null&&typeof e=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(e){return e&&e._delegate?e._delegate:e}class Qe{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xu{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ou(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ou(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const os="@firebase/app",ji="0.9.26";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Dt=new Ho("app","Firebase",ul);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dl=ol;function Jo(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:as,automaticDataCollectionEnabled:!1},t),s=r.name;if(typeof s!="string"||!s)throw Dt.create("bad-app-name",{appName:String(s)});if(n||(n=zo()),!n)throw Dt.create("no-options");const i=zn.get(s);if(i){if(rs(n,i.options)&&rs(r,i.config))return i;throw Dt.create("duplicate-app",{appName:s})}const o=new yu(s);for(const h of hs.values())o.addComponent(h);const a=new ll(n,r,o);return zn.set(s,a),a}function fl(e=as){const t=zn.get(e);if(!t&&e===as&&zo())return Jo();if(!t)throw Dt.create("no-app",{appName:e});return t}function ce(e,t,n){var r;let s=(r=al[e])!==null&&r!==void 0?r:e;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=t.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${t}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),zt.warn(a.join(" "));return}Kn(new Qe(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ml="firebase-heartbeat-database",gl=1,We="firebase-heartbeat-store";let Gr=null;function Xo(){return Gr||(Gr=bu(ml,gl,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(We)}catch(n){console.warn(n)}}}}).catch(e=>{throw Dt.create("idb-open",{originalErrorMessage:e.message})})),Gr}async function pl(e){try{return await(await Xo()).transaction(We).objectStore(We).get(Zo(e))}catch(t){if(t instanceof Ae)zt.warn(t.message);else{const n=Dt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});zt.warn(n.message)}}}async function qi(e,t){try{const r=(await Xo()).transaction(We,"readwrite");await r.objectStore(We).put(t,Zo(e)),await r.done}catch(n){if(n instanceof Ae)zt.warn(n.message);else{const r=Dt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});zt.warn(r.message)}}}function Zo(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tl(e){Kn(new Qe("platform-logger",t=>new xu(t),"PRIVATE")),Kn(new Qe("heartbeat",t=>new El(t),"PRIVATE")),ce(os,ji,e),ce(os,ji,"esm2017"),ce("fire-js","")}Tl("");var Il="firebase",wl="10.7.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kt=new Qo("@firebase/firestore");function ke(){return Kt.logLevel}function p(e,...t){if(Kt.logLevel<=D.DEBUG){const n=t.map(ni);Kt.debug(`Firestore (${we}): ${e}`,...n)}}function yt(e,...t){if(Kt.logLevel<=D.ERROR){const n=t.map(ni);Kt.error(`Firestore (${we}): ${e}`,...n)}}function me(e,...t){if(Kt.logLevel<=D.WARN){const n=t.map(ni);Kt.warn(`Firestore (${we}): ${e}`,...n)}}function ni(e){if(typeof e=="string")return e;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A(e="Unexpected state"){const t=`FIRESTORE (${we}) INTERNAL ASSERTION FAILED: `+e;throw yt(t),new Error(t)}function N(e,t){e||A()}function R(e,t){return e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ao(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Re(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function ih(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oi(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function ai(e){const t=e.mapValue.fields.__previous_value__;return oi(t)?ai(t):t}function on(e){const t=Nt(e.mapValue.fields.__local_write_time__.timestampValue);return new q(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(t,n=null,r=[],s=[],i=null,o="F",a=null,h=null){this.path=t,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=s,this.limit=i,this.limitType=o,this.startAt=a,this.endAt=h,this.le=null,this.he=null,this.Pe=null,this.startAt,this.endAt}}function hf(e,t,n,r,s,i,o,a){return new Rr(e,t,n,r,s,i,o,a)}function mh(e){return new Rr(e)}function po(e){return e.filters.length===0&&e.limit===null&&e.startAt==null&&e.endAt==null&&(e.explicitOrderBy.length===0||e.explicitOrderBy.length===1&&e.explicitOrderBy[0].field.isKeyField())}function cf(e){return e.collectionGroup!==null}function qe(e){const t=R(e);if(t.le===null){t.le=[];const n=new Set;for(const i of t.explicitOrderBy)t.le.push(i),n.add(i.field.canonicalString());const r=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";(function(o){let a=new X(Y.comparator);return o.filters.forEach(h=>{h.getFlattenedFilters().forEach(c=>{c.isInequality()&&(a=a.add(c.field))})}),a})(t).forEach(i=>{n.has(i.canonicalString())||i.isKeyField()||t.le.push(new er(i,r))}),n.has(Y.keyField().canonicalString())||t.le.push(new er(Y.keyField(),r))}return t.le}function pt(e){const t=R(e);return t.he||(t.he=uf(t,qe(e))),t.he}function uf(e,t){if(e.limitType==="F")return go(e.path,e.collectionGroup,t,e.filters,e.limit,e.startAt,e.endAt);{t=t.map(s=>{const i=s.dir==="desc"?"asc":"desc";return new er(s.field,i)});const n=e.endAt?new tr(e.endAt.position,e.endAt.inclusive):null,r=e.startAt?new tr(e.startAt.position,e.startAt.inclusive):null;return go(e.path,e.collectionGroup,t,e.filters,e.limit,n,r)}}function Rs(e,t,n){return new Rr(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function Sr(e,t){return ui(pt(e),pt(t))&&e.limitType===t.limitType}function gh(e){return`${ci(pt(e))}|lt:${e.limitType}`}function se(e){return`Query(target=${function(n){let r=n.path.canonicalString();return n.collectionGroup!==null&&(r+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(r+=`, filters: [${n.filters.map(s=>dh(s)).join(", ")}]`),wr(n.limit)||(r+=", limit: "+n.limit),n.orderBy.length>0&&(r+=`, orderBy: [${n.orderBy.map(s=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(s)).join(", ")}]`),n.startAt&&(r+=", startAt: ",r+=n.startAt.inclusive?"b:":"a:",r+=n.startAt.position.map(s=>_e(s)).join(",")),n.endAt&&(r+=", endAt: ",r+=n.endAt.inclusive?"a:":"b:",r+=n.endAt.position.map(s=>_e(s)).join(",")),`Target(${r})`}(pt(e))}; limitType=${e.limitType})`}function Pr(e,t){return t.isFoundDocument()&&function(r,s){const i=s.key.path;return r.collectionGroup!==null?s.key.hasCollectionId(r.collectionGroup)&&r.path.isPrefixOf(i):E.isDocumentKey(r.path)?r.path.isEqual(i):r.path.isImmediateParentOf(i)}(e,t)&&function(r,s){for(const i of qe(r))if(!i.field.isKeyField()&&s.data.field(i.field)===null)return!1;return!0}(e,t)&&function(r,s){for(const i of r.filters)if(!i.matches(s))return!1;return!0}(e,t)&&function(r,s){return!(r.startAt&&!function(o,a,h){const c=fo(o,a,h);return o.inclusive?c<=0:c<0}(r.startAt,qe(r),s)||r.endAt&&!function(o,a,h){const c=fo(o,a,h);return o.inclusive?c>=0:c>0}(r.endAt,qe(r),s))}(e,t)}function lf(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function ph(e){return(t,n)=>{let r=!1;for(const s of qe(e)){const i=df(s,t,n);if(i!==0)return i;r=r||s.field.isKeyField()}return 0}}function df(e,t,n){const r=e.field.isKeyField()?E.comparator(t.key,n.key):function(i,o,a){const h=o.data.field(i),c=a.data.field(i);return h!==null&&c!==null?pe(h,c):A()}(e.field,t,n);switch(e.dir){case"asc":return r;case"desc":return-1*r;default:return A()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ff=new L(E.comparator);function St(){return ff}const _h=new L(E.comparator);function Oe(...e){let t=_h;for(const n of e)t=t.insert(n.key,n);return t}function yh(e){let t=_h;return e.forEach((n,r)=>t=t.insert(n,r.overlayedDocument)),t}function $t(){return $e()}function Eh(){return $e()}function $e(){return new Se(e=>e.toString(),(e,t)=>e.isEqual(t))}const mf=new L(E.comparator),gf=new X(E.comparator);function P(...e){let t=gf;for(const n of e)t=t.add(n);return t}const pf=new X(b);function _f(){return pf}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(t,n,r,s,i){this.snapshotVersion=t,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,n,r){const s=new Map;return s.set(t,In.createSynthesizedTargetChangeForCurrentChange(t,n,r)),new Dr(w.min(),s,new L(b),St(),P())}}class In{constructor(t,n,r,s,i){this.resumeToken=t,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,n,r){return new In(r,n,P(),P(),P())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return uu()?8:qt.v(Gn())>0?6:4}()}initialize(t,n){this.zi=t,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(t,n,r,s){const i={result:null};return this.ji(t,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Hi(t,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new lm;return this.Ji(t,n,o).next(a=>{if(i.result=a,this.Ui)return this.Yi(t,n,o,a.size)})}).next(()=>i.result)}Yi(t,n,r,s){return r.documentReadCount<this.Wi?(ke()<=D.DEBUG&&p("QueryEngine","SDK will not create cache indexes for query:",se(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),d.resolve()):(ke()<=D.DEBUG&&p("QueryEngine","Query:",se(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Gi*s?(ke()<=D.DEBUG&&p("QueryEngine","The SDK decides to create cache indexes for query:",se(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,pt(n))):d.resolve())}ji(t,n){if(po(n))return d.resolve(null);let r=pt(n);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Rs(n,null,"F"),r=pt(n)),this.indexManager.getDocumentsMatchingTarget(t,r).next(i=>{const o=P(...i);return this.zi.getDocuments(t,o).next(a=>this.indexManager.getMinOffset(t,r).next(h=>{const c=this.Zi(n,a);return this.Xi(n,c,o,h.readTime)?this.ji(t,Rs(n,null,"F")):this.es(t,c,n,h)}))})))}Hi(t,n,r,s){return po(n)||s.isEqual(w.min())?d.resolve(null):this.zi.getDocuments(t,r).next(i=>{const o=this.Zi(n,i);return this.Xi(n,o,r,s)?d.resolve(null):(ke()<=D.DEBUG&&p("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),se(n)),this.es(t,o,n,Ud(s,-1)).next(a=>a))})}Zi(t,n){let r=new X(ph(t));return n.forEach((s,i)=>{Pr(t,i)&&(r=r.add(i))}),r}Xi(t,n,r,s){if(t.limit===null)return!1;if(r.size!==n.size)return!0;const i=t.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ji(t,n,r){return ke()<=D.DEBUG&&p("QueryEngine","Using full collection scan to execute query:",se(n)),this.zi.getDocumentsMatchingQuery(t,n,kt.min(),r)}es(t,n,r,s){return this.zi.getDocumentsMatchingQuery(t,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function br(e){return new Lf(e,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dm{constructor(t,n,r,s,i){this.localStore=t,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.D_=[],this.C_=new Map,this.v_=new Set,this.F_=[],this.M_=i,this.M_.io(o=>{r.enqueueAndForget(async()=>{Jt(this)&&(p("RemoteStore","Restarting streams for network reachability change."),await async function(h){const c=R(h);c.v_.add(4),await wn(c),c.x_.set("Unknown"),c.v_.delete(4),await kr(c)}(this))})}),this.x_=new Vm(r,s)}}async function kr(e){if(Jt(e))for(const t of e.F_)await t(!0)}async function wn(e){for(const t of e.F_)await t(!1)}function $h(e,t){const n=R(e);n.C_.has(t.targetId)||(n.C_.set(t.targetId,t),Ei(n)?yi(n):Pe(n).Jo()&&_i(n,t))}function Gh(e,t){const n=R(e),r=Pe(n);n.C_.delete(t),r.Jo()&&zh(n,t),n.C_.size===0&&(r.Jo()?r.Xo():Jt(n)&&n.x_.set("Unknown"))}function _i(e,t){if(e.O_.Oe(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(w.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}Pe(e).c_(t)}function zh(e,t){e.O_.Oe(t),Pe(e).l_(t)}function yi(e){e.O_=new kf({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),_t:t=>e.C_.get(t)||null,nt:()=>e.datastore.serializer.databaseId}),Pe(e).start(),e.x_.p_()}function Ei(e){return Jt(e)&&!Pe(e).Ho()&&e.C_.size>0}function Jt(e){return R(e).v_.size===0}function Kh(e){e.O_=void 0}async function bm(e){e.C_.forEach((t,n)=>{_i(e,t)})}async function km(e,t){Kh(e),Ei(e)?(e.x_.S_(t),yi(e)):e.x_.set("Unknown")}async function Nm(e,t,n){if(e.x_.set("Online"),t instanceof bh&&t.state===2&&t.cause)try{await async function(s,i){const o=i.cause;for(const a of i.targetIds)s.C_.has(a)&&(await s.remoteSyncer.rejectListen(a,o),s.C_.delete(a),s.O_.removeTarget(a))}(e,t)}catch(r){p("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await ir(e,r)}else if(t instanceof jn?e.O_.$e(t):t instanceof Dh?e.O_.Je(t):e.O_.Ge(t),!n.isEqual(w.min()))try{const r=await Uh(e.localStore);n.compareTo(r)>=0&&await function(i,o){const a=i.O_.it(o);return a.targetChanges.forEach((h,c)=>{if(h.resumeToken.approximateByteSize()>0){const u=i.C_.get(c);u&&i.C_.set(c,u.withResumeToken(h.resumeToken,o))}}),a.targetMismatches.forEach((h,c)=>{const u=i.C_.get(h);if(!u)return;i.C_.set(h,u.withResumeToken(st.EMPTY_BYTE_STRING,u.snapshotVersion)),zh(i,h);const l=new Ct(u.target,h,c,u.sequenceNumber);_i(i,l)}),i.remoteSyncer.applyRemoteEvent(a)}(e,n)}catch(r){p("RemoteStore","Failed to raise snapshot:",r),await ir(e,r)}}async function ir(e,t,n){if(!An(t))throw t;e.v_.add(1),await wn(e),e.x_.set("Offline"),n||(n=()=>Uh(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{p("RemoteStore","Retrying IndexedDB access"),await n(),e.v_.delete(1),await kr(e)})}function Hh(e,t){return t().catch(n=>ir(e,n,t))}async function Nr(e){const t=R(e),n=xt(t);let r=t.D_.length>0?t.D_[t.D_.length-1].batchId:-1;for(;xm(t);)try{const s=await ym(t.localStore,r);if(s===null){t.D_.length===0&&n.Xo();break}r=s.batchId,Om(t,s)}catch(s){await ir(t,s)}Qh(t)&&Wh(t)}function xm(e){return Jt(e)&&e.D_.length<10}function Om(e,t){e.D_.push(t);const n=xt(e);n.Jo()&&n.P_&&n.I_(t.mutations)}function Qh(e){return Jt(e)&&!xt(e).Ho()&&e.D_.length>0}function Wh(e){xt(e).start()}async function Lm(e){xt(e).d_()}async function Mm(e){const t=xt(e);for(const n of e.D_)t.I_(n.mutations)}async function Fm(e,t,n){const r=e.D_.shift(),s=li.from(r,t,n);await Hh(e,()=>e.remoteSyncer.applySuccessfulWrite(s)),await Nr(e)}async function Bm(e,t){t&&xt(e).P_&&await async function(r,s){if(function(o){return Vf(o)&&o!==f.ABORTED}(s.code)){const i=r.D_.shift();xt(r).Zo(),await Hh(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Nr(r)}}(e,t),Qh(e)&&Wh(e)}async function Do(e,t){const n=R(e);n.asyncQueue.verifyOperationInProgress(),p("RemoteStore","RemoteStore received new credentials");const r=Jt(n);n.v_.add(3),await wn(n),r&&n.x_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.v_.delete(3),await kr(n)}async function Um(e,t){const n=R(e);t?(n.v_.delete(2),await kr(n)):t||(n.v_.add(2),await wn(n),n.x_.set("Unknown"))}function Pe(e){return e.N_||(e.N_=function(n,r,s){const i=R(n);return i.R_(),new Sm(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(e.datastore,e.asyncQueue,{Po:bm.bind(null,e),To:km.bind(null,e),u_:Nm.bind(null,e)}),e.F_.push(async t=>{t?(e.N_.Zo(),Ei(e)?yi(e):e.x_.set("Unknown")):(await e.N_.stop(),Kh(e))})),e.N_}function xt(e){return e.B_||(e.B_=function(n,r,s){const i=R(n);return i.R_(),new Pm(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(e.datastore,e.asyncQueue,{Po:Lm.bind(null,e),To:Bm.bind(null,e),E_:Mm.bind(null,e),T_:Fm.bind(null,e)}),e.F_.push(async t=>{t?(e.B_.Zo(),await Nr(e)):(await e.B_.stop(),e.D_.length>0&&(p("RemoteStore",`Stopping write stream with ${e.D_.length} pending writes`),e.D_=[]))})),e.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(t){this.comparator=t?(n,r)=>t(n,r)||E.comparator(n.key,r.key):(n,r)=>E.comparator(n.key,r.key),this.keyedMap=Oe(),this.sortedSet=new L(this.comparator)}static emptySet(t){return new de(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const n=this.keyedMap.get(t);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((n,r)=>(t(n),!1))}add(t){const n=this.delete(t.key);return n.copy(n.keyedMap.insert(t.key,t),n.sortedSet.insert(t,null))}delete(t){const n=this.get(t);return n?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(n)):this}isEqual(t){if(!(t instanceof de)||this.size!==t.size)return!1;const n=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;n.hasNext();){const s=n.getNext().key,i=r.getNext().key;if(!s.isEqual(i))return!1}return!0}toString(){const t=[];return this.forEach(n=>{t.push(n.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{constructor(t,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Or(this.firestore,t,this._query)}}class lt{constructor(t,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new bt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new lt(this.firestore,t,this._key)}}class bt extends Or{constructor(t,n,r){super(t,n,mh(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new lt(this.firestore,null,new E(t))}withConverter(t){return new bt(this.firestore,t,this._path)}}function Uo(e,t,...n){if(e=He(e),sc("collection","path",t),e instanceof xr){const r=O.fromString(t,...n);return Fo(r),new bt(e,null,r)}{if(!(e instanceof lt||e instanceof bt))throw new y(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(O.fromString(t,...n));return Fo(r),new bt(e.firestore,null,r)}}function vg(e,t,...n){if(e=He(e),arguments.length===1&&(t=sh.newId()),sc("doc","path",t),e instanceof xr){const r=O.fromString(t,...n);return Mo(r),new lt(e,null,new E(r))}{if(!(e instanceof lt||e instanceof bt))throw new y(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(O.fromString(t,...n));return Mo(r),new lt(e.firestore,e instanceof bt?e.converter:null,new E(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
